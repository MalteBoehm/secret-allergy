...
export default function DashboardMealSideEffects({ checkSideEffects, hasSideEffects, navigation, item }) {
          ...
          {hasSideEffects ? <Text>Grafik ist sichtbar</Text> :
            <Row>
              <Text style={{textAlign: "center",}}>
                {checkSideEffects ? checkSideEffects.map(sideEffect => sideEffect):<Text>starke Magenkrämpfe</Text>}
              </Text>
            </Row>
          }
        ...
        <Col size={0.33} style={{ alignSelf: "right" }}>
          ...
          <View style={{ justifyContent: "flex-end" }}>
            <FontAwesome.Button iconRight style={RowContainerStyled.buttonToDetail}
                                ...
                                onPress={() =>
                                  navigation.navigate("ReviewScreen", { mealParam: item.kindOfMeal })}>
            </FontAwesome.Button>
          </View>
        </Col>
      </Row>
